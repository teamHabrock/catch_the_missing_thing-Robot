...
// Motor control pins
#define Delay_Right 1000
#define Delay_Left 1000
#define ENA 5
#define IN1 7
#define IN2 6
#define ENB 10
...
#define LEFT 2
#define RIGHT -2
#define TIME_BYPASS_OBSTACLE 200
...
const int obstacleThreshold = 30; // Obstacle detection threshold in cm
...
void loop()
{
  ...
  bool Object_Detected1 = moveDistance(15); // the nubmer in cm
...
bool avoidObstacle()
{
  Serial.println("enert avoidObstacle");
